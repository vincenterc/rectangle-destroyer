...
public class LevelScreen extends BaseScreen
{
    ...
    public void update(float dt)
    {
        ...
        for (BaseActor wall : BaseActor.getList(mainStage, "com.vincenterc.rectangledestroyer.Wall"))
        {  
        ...
        for (BaseActor brick : BaseActor.getList(mainStage, "com.vincenterc.rectangledestroyer.Brick"))
        {  
        ...
        if ( ball.getY() < -50 && BaseActor.count(mainStage, "com.vincenterc.rectangledestroyer.Brick") > 0 )
        {
            ball.remove();
        ...
        for (BaseActor item : BaseActor.getList(mainStage, "com.vincenterc.rectangledestroyer.Item"))
        {  
